...
El comando `select` nos permite igual ordenar las columnas de diferente forma, supóngamos que queremos `continente` al principio y todas las demás columnas igual. Lo anterior lo realizamos mediante el siguiente comando
...
```{r ejer2_4, echo=TRUE}
starwars %>% filter(homeworld == "Tatooine" & gender == "masculino") %>%  select(name, homeworld) %>% kable()
```
